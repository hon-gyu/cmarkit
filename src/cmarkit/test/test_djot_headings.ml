...
let%expect_test "djot: the heading runs until a blank line" =
  html ~multiline_atx_headings:true ~atx_closing_sequence:false
    "# A heading that\ntakes up two lines\n";
  [%expect
    {|
...
let%expect_test "closing sequences are independent of multiline headings" =
  html ~atx_closing_sequence:false "# heading ###\n";
  [%expect
    {| <h1 id="heading-"><a class="anchor" aria-hidden="true" href="#heading-"></a>heading ###</h1> |}]
