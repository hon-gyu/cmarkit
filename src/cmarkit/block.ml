...
| Ext_attributes (_, m)
| Ext_div (_, m)
| Ext_keyed_list_item (_, m) | Ext_keyed_block (_, m)
...
| Ext_keyed_list_item ((l, b), m) ->
    Ext_keyed_list_item ((l, normalize ~ext b), m)
| Ext_keyed_block ((l, b), m) ->
    Ext_keyed_block ((l, normalize ~ext b), m)
| b -> ext b
...
let rec defs
  ...
  | Ext_keyed_list_item ((_, b), _) | Ext_keyed_block ((_, b), _) ->
      defs ~ext ~init b
  | b -> ext init b
